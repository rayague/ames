...
<li class="nav-item">
    <a class="nav-link active-link" href="{{ route('produits.create') }}">
...
<li class="nav-item">
    <form method="POST" action="{{ route('logout') }}">
        @csrf
        <button type="submit" class="nav-link btn btn-link" style="padding-left: 1.5rem; background-color: red;">
                    ...
                    @endif
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-success">Ajouter un produit / équipement</h6>
                            </div>
                            <div class="card-body">
                                <form action="/produits" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="nom" class="form-label fw-bold">Nom du produit / équipement <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="nom" name="nom" required placeholder="Entrez le nom complet">
                                        </div>

                                        <!-- Catégorie -->
                                        <div class="col-md-6 mb-3">
                                            <label for="categorie_id" class="form-label fw-bold text-primary">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="marque" name="marque" placeholder="Ex : Cromatest, TERUMO...">
                                        </div>

                                        <!-- Modèle -->
                                        <div class="col-md-4 mb-3">
                                            <label for="modele" class="form-label">Modèle</label>
                                            <input type="text" class="form-control" id="modele" name="modele" placeholder="Numéro ou nom du modèle">
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="number" class="form-control" id="quantite" name="quantite" min="0" placeholder="0">
                                        </div>

                                        <!-- Prix unitaire -->
                                        <div class="col-md-4 mb-3">
                                            <label for="prix" class="form-label">Prix unitaire (en FCFA)</label>
                                            <input type="number" step="0.01" class="form-control" id="prix" name="prix" min="0" placeholder="0.00">
                                        </div>

                                        <!-- Lieu d'achat -->
                                        <div class="col-md-4 mb-3">
                                            <label for="lieu_achat" class="form-label">Lieu d'achat</label>
                                            <input type="text" class="form-control" id="lieu_achat" name="lieu_achat" placeholder="Ex : Cotonou, Paris...">
                                        </div>
                                    </div>
