                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="container mt-4">
                                ...
                                <form action="{{ route('categories.update', $categorie->id) }}" method="POST" class="card shadow p-4">
                                    @csrf
                                    @method('PUT')

                                    <div class="mb-3">
                                        <label for="nom" class="form-label">Nom de la catégorie</label>
                                        <input type="text" name="nom" id="nom" value="{{ old('nom', $categorie->nom) }}" class="form-control" required>
                                    </div>
