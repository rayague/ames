        ...
        <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
                    ...
                    <section class="relative min-h-screens w-full flex flex-col bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 overflow-hidden">
                                        ...
                                        <div class="absolute inset-0">
                                            ...
                                            <div class="absolute top-0 left-0 w-full h-full bg-[url('/images/hero-medical.jpg')] bg-cover bg-center opacity-30"></div>
                                            ...
                                            <div class="text-center space-y-8 pt-16 sm:pt-20 md:pt-24">
                                                ...
                                                <div class="inline-flex items-center justify-center animate-slide-up">
                                                    <span class="relative bg-gradient-to-r from-white/20 to-white/10 backdrop-blur-md text-white px-8 py-3 rounded-full font-bold tracking-widest text-lg shadow-2xl border border-white/20 hover:border-white/40 transition-all duration-500 group">
                                                        ...
                                                        <span class="relative">AMES MED EQUIPEMENTS</span>
                                                    </span>
                                                </div>
                                                ...
                                                <p class="text-base sm:text-lg md:text-xl lg:text-2xl mb-8 sm:mb-12 text-white/90 font-medium max-w-4xl mx-auto leading-relaxed animate-slide-up-delay-2 px-4">
                                                    Représentation, importation et distribution d'équipements médicaux, consommables et réactifs de laboratoire pour le diagnostic in vitro
                                                </p>
                                        ...
                                        <div class="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
                                            <div class="text-center mb-16 animate-slide-up">
                                                ...
                                                <p class="text-lg sm:text-xl text-gray-700 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed font-medium">
                                                    Nos valeurs guident chaque action que nous entreprenons pour vous servir au mieux
                                                </p>
                                            </div>
                                    ...
                                    <section id="produits" class="relative py-20 bg-gradient-to-br from-gray-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-indigo-900 dark:to-purple-900 overflow-hidden">
                                        ...
                                        <div class="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
                                            <div class="text-center mb-16 animate-slide-up">
                                                ...
                                                <p class="text-lg sm:text-xl text-gray-700 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed font-medium">
                                                    Découvrez quelques-uns des équipements les plus demandés par nos clients
                                                </p>
                                            </div>
                                    ...
                                    <section class="relative py-20 bg-gradient-to-br from-white via-gray-50 to-indigo-50 dark:from-gray-800 dark:via-gray-900 dark:to-indigo-900 overflow-hidden">
                                        ...
                                        <div class="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
                                            <div class="text-center mb-16 animate-slide-up">
                                                ...
                                                <p class="text-lg sm:text-xl text-gray-700 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed font-medium">
                                                    Nous avons des partenaires hautement qualifiés et disponibles pour vous satisfaire
                                                </p>
                                            </div>
